    ...
    <div>
        <div className="flex flex-col justify-between w-full h-full px-6 py-6 bg-gray-100 dark:bg-gray-800 md:px-14 rounded-2xl md:py-14 dark:bg-trueGray-800">
            <div className="items-center flex justify-center px-5 lg:px-0">
                <h2 className="text"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae perspiciatis ab eius? Id omnis amet ad architecto illo obcaecati quas sint, recusandae delectus earum ea, vitae quos explicabo culpa beatae!</h2>
