    ...
    <div className="row">
      ...
      <div className="col-lg-7 col-md-6 px-0">
        <div className="map_container">
          <div className="map-responsive">
            <img src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Eiffel+Tower+Paris+France" />
          </div>
        </div>
      </div>
      </div>
      ...
      <div className="col-md-6 col-lg-5 px-0 ">
        ...
        <form action="">
          ...
          <input type="email" className=" placeholder placeholder-red-900 px-2 py-1" name="name" id="name" />
          </div>
